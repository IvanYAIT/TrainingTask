...
namespace Level
{
    public class LevelPool
    {
        ...
        [Inject]
        public LevelPool(LevelData levelData, Transform levelPartContainer)
        {
            _container = levelPartContainer;
            _baseLevelPartPrefab = levelData.BaseLevelPartPrefab;
            CreatePool(levelData.PoolSize);
        }
